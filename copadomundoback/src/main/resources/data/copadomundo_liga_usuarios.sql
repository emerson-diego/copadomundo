...
CREATE TABLE `liga_usuarios` (
  ...
  KEY `FKrxbgpqo4pbjpx2sryr9a64wwg` (`usuario_id`),
  KEY `FK2tguqhjjgsbdk0yrksv2evohn` (`liga_id`),
  CONSTRAINT `FK2tguqhjjgsbdk0yrksv2evohn` FOREIGN KEY (`liga_id`) REFERENCES `tb_liga` (`id`),
  CONSTRAINT `FKrxbgpqo4pbjpx2sryr9a64wwg` FOREIGN KEY (`usuario_id`) REFERENCES `tb_usuario` (`id`)
...
-- Dump completed on 2021-09-04 14:51:40
